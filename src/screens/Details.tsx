...
import { VStack, Text, useTheme, ScrollView, HStack, Box } from "native-base";
    ...
    <VStack flex={1} bg="gray.700">
      ...
      <HStack bg="gray.500" justifyContent="center" p={4}>
        {order.status === "closed" ? (
          ...
          <FontAwesome name="hourglass-o" size={20} color={colors.secondary[700]} />
        )}
      ...
      {/* se o conteúdo não cabe na tela, o ScrollView ativa a rolagem */}
      <ScrollView mx={5} showsVerticalScrollIndicator={false}>
        <CardDetails
          title="equipamento"
          description={`Patrimônio ${order.patrimony}`}
          icon={<FontAwesome name="laptop" size={24} color="black" />}
        />
        ...
        <CardDetails
          title="solução"
          icon={<FontAwesome name="check-circle-o" size={24} color="black" />}
